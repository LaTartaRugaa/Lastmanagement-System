...
p_device_text = "Aktuelle Leistung des Lastmanagementsystem: "
energy_flow_text = "Energiefluss von heute: "
...
class LabelText:
    ...
    def bool_to_text(self, sub_key, text_true, text_false = ""):
        # Erstellen eines Strings für die Anzeige in der App aufgrund des bereitgestellten Booleans
    ...
    def int_to_text(self, sub_key, text):
        # Erstellen eines Strings für die Anzeige in der App aufgrund des bereitgestellten Integers
...
class UI(MDFloatLayout):
    ...
    def update(self, sub_key = None, updated_data_mobile = None, *args):
        # Aktualisierung der Daten in der App mit den Daten aus dem Github-Repository
        if updated_data_mobile == None:
            ...
            self.ids.p_device.text = l_pi.int_to_text("p_device", p_device_text) + " W"

            l_pi.base_url["energy_flow"] = round(list(l_pi.base_url["energy_flow"].values())[0] / 3600, 1)
            self.ids.energy_flow.text = l_pi.int_to_text("energy_flow", energy_flow_text) + " Wh"
    ...
    def start_update_thread(self, sub_key = None, updated_data_mobile = None):
        # Start eines weiteren Threads, um die App nicht zu blockieren
        Thread(target = self.update, args = (sub_key, updated_data_mobile)).start()
    

    def set_mode(self, id):
        # Aktualisierung des Lademodus
    ...
    def set_device_state(self):
        # Abschalten des Lastmanagementsystems
    ...
    def set_standby(self):
        # Aktualisierung des Standby-Zustandes
...
class App(MDApp):
    def build(self):
        ...
        # Wiederholte Aktualisierung der Daten in der App
