...
Dieser Ordner beinhaltet den Code für die Lastmanagement-App. Allerdings fehlt zur Ausführung der App noch die Datei credentials.py. Da sich in dieser Datei das Access-Token befindet, musste diese weggelassen werden.
